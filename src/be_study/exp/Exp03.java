...
public class Exp03 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("addItem2 enf 호출한 main에서 예외처리");
		}
		...
		try {
			...
			e.printStackTrace();
			System.out.println("addItem5 다섯 main에서 호출한 Exception 예외처리");
		}
		...
		try {
			...
			e.printStackTrace();
			System.out.println("addItem6 여섯 main에서 호출한 Exception 예외처리");
		}
		...
		try {
			...
			e.printStackTrace();
			System.out.println("addItem 아홉 main에서 호출 후, ListFullException 예외처리");
		} catch (InvalidParameterValueException e) {
			e.printStackTrace();
			System.out.println("addItem 아홉 main에서 호출 후, InvalidParameterValueException 예외처리");
		}
...
class SampleEx {
	...
	void addItem2(String s) {
		...
		try {
			...
			System.out.println("SampleEx 내부 addItem 에서 예외처리");
		}
	}
