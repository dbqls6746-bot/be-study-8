...
//		나누기 : ㅇ/ㅇ=ㅇ
		...
		System.out.println("더하기 : " + num1 + "+" + num2 + "=" + result1);
		
		int result2 = num1-num2;
		System.out.println("빼기 : " + num1 + "-" + num2 + "=" + result2);
		
		int result3 = num1*num2;
		System.out.println("곱하기 : " + num1 + "*" + num2 + "=" + result3);
		
		double result4 = (double)num1/num2;
		System.out.println("나누기 : " + num1 + "/" + num2 + "=" + result4);
	}
